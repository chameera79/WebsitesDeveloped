        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="orderdetailenter.php">Add to Shipping</a>
                    </li>
    ...
    <div class="container">
      ...
      <div class="row text-center" >
        ...
        <div class="col-md-3 col-sm-6 hero-feature" >
           <?php
           $result3=mysqli_query($con,"select pid from `temp_orders` where username='$add'");
         while($data3=mysqli_fetch_array($result3))
          {
                 $id = $data3['pid'] ;
				 $shopping1=mysqli_query($con,"select * from `products` where pid='$id'");
				   while($data3=mysqli_fetch_array($shopping1))
          {
                 
				 $name = $data3['pname'] ;
				  $price = $data3['price'] ;
                  $path = $data3['item_path'] ;
